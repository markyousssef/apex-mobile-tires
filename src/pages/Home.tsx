  ...
  return (
    <>
      <div id="home-above-fold">
        <section id="hero">
          <p className="hero-body">Apex Mobile Tire is an independent mobile tire service based in Thousand Oaks, CA. We come to you, whether that is your home, your office, or anywhere in between.</p>
