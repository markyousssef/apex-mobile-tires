...
export default function AboutDesktop() {
  ...
  return (
    <div id="about-desktop-wrap">
      <div id="about-desktop-left">
        <h1 className="section-title about-desktop-title">Who We Are</h1>
      ...
      <div id="about-desktop-right">
        {slides.map((src, i) => (
          <img
            key={i}
            src={src}
            alt=""
            className={`about-slide-img${current === i ? ' active' : ''}`}
          />
        ))}
      </div>
    </div>
